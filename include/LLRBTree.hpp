#ifndef P1_QUICKSORT_NDMITRIY98_LLRBTREE_HPP
#define P1_QUICKSORT_NDMITRIY98_LLRBTREE_HPP
...
template <typename K, typename V>
V* LLRBTree<K, V>::search(const K& key) const
{
    Node* x = root;
...
#endif //P1_QUICKSORT_NDMITRIY98_LLRBTREE_HPP
